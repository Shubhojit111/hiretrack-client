...
const Landing = () => {
  return (
    <div className="min-h-screen px-36 bg-linear-to-br from-[#071129] via-[#0a1b3d] to-[#051021] text-white relative overflow-hidden">
      {/* Navbar */}
      <div className="flex justify-between items-center py-4">
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="cursor-pointer bg-blue-600 hover:bg-blue-700 px-5 py-2 rounded-lg text-sm font-medium transition">
      ...
      <div className=" mt-20 flex flex-col lg:flex-row items-center justify-between gap-16">
        ...
        <div className="max-w-2xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full text-sm text-gray-300 mb-4">
          ...
          <p className="text-gray-400 mt-4 text-lg leading-relaxed">
            Stop losing track of applications. HireTrack helps you manage your
            entire job search with AI-powered resume analysis, cover letter
            generation, and smart analytics.
          </p>

          {/* Buttons */}
          <div className="flex gap-6 mt-6">
            <Link to="/register">
              <button className="cursor-pointer bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-xl font-medium transition">
                Start Free →
              </button>
            </Link>
            <button className="cursor-pointer bg-white/10 backdrop-blur-md px-6 py-3 rounded-xl text-gray-200 hover:bg-white/20 transition">
              See Features
            </button>
          </div>
          ...
          <div className="flex items-center gap-2 mt-10">
            <div className="flex -space-x-1.5">
              ...
              <div className="w-7 h-7 bg-yellow-500 rounded-full flex items-center justify-center text-sm font-bold">
                S
              </div>
            ...
            <p className="text-gray-400 text-sm">
              <span className="text-white font-semibold">10,000+</span> job
              seekers trust <span classname="text-white">HireTrack</span>
            </p>
          </div>
        </div>
